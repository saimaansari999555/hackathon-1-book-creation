...
const config: Config = {
  ...
  tagline: 'A technical book on Embodied Intelligence',
  ...
  organizationName: 'Waiz', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Waiz/hackathon-1',
          label: 'GitHub',
          position: 'right',
        },
      ],
